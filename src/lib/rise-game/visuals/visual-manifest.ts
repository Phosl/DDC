...
export const PLAYER_VISUAL = {
  ...
  animations: {
    ...
    run: {
      key: "davide-v3-run",
      textureKey: ACTOR_ATLAS.player.key,
      frames: [2, 3, 4, 5] as readonly number[],
      frameRate: 16,
      repeat: -1,
      priority: 10,
    },
    ...
    "fire-diagonal": {
      ...
      textureKey: ACTOR_ATLAS.player.key,
      frames: [16, 17] as readonly number[],
      frameRate: 16,
      durationMs: 170,
      repeat: 0,
      priority: 50,
    ...
    hit: {
      key: "davide-v3-hit",
      textureKey: ACTOR_ATLAS.player.key,
      frames: [18, 19] as readonly number[],
      frameRate: 16,
      durationMs: 220,
      repeat: 0,
      priority: 80,
    ...
    defeat: {
      ...
      textureKey: ACTOR_ATLAS.player.key,
      frames: [20, 21] as readonly number[],
      frameRate: 7,
      durationMs: 560,
      repeat: 0,
      priority: 100,
    ...
    respawn: {
      ...
      textureKey: ACTOR_ATLAS.player.key,
      frames: [22, 23] as readonly number[],
      frameRate: 8,
      durationMs: 420,
      repeat: 0,
      priority: 90,
